...
public class GuiCredits extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, "Filip", this.width / 2 / authorScale, this.height / 3 / authorScale + 100, -1);
        GlStateManager.popMatrix();
        ...
        this.drawCenteredString(this.fontRendererObj, EnumChatFormatting.GRAY + "Player View element", this.width / 2, this.height / 3 + 140, -1);
